...
// ==== Invoke marbles ====
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["createAsset","marble1","blue","35","tom"]}'
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["createAsset","marble2","red","50","tom"]}'
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["createAsset","marble3","blue","70","tom"]}'
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["transferMarble","marble2","jerry"]}'
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["transferMarblesBasedOnColor","blue","jerry"]}'
// peer chaincode invoke -C myc1 -n marbles -c '{"Args":["delete","marble1"]}'

// ==== Query marbles ====
// peer chaincode query -C myc1 -n marbles -c '{"Args":["ReadAsset","marble1"]}'
...
let Chaincode = class {
  ...
  // ===============================================
  // createAsset - create a new marble
  // ===============================================
  async createAsset(stub, args, thisClass) {
    ...
    exists = await assetExists(stub, marbleName)
    if (exists) {
      throw new Error('')
    }
  ...
  async assetExists(stub, marbleName) {
    // ==== Check if marble already exists ====
    let marbleState = await stub.getState(marbleName);
    if ( !marbleState || marbleState.length === 0 ) {
      return false;
    }
    return true
  }
  ...
  // ===============================================
  // ReadAsset - read a marble from chaincode state
  // ===============================================
